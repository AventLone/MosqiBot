...
Task::Task() : group_index(0)
{
    ...
    mCleanUpServer = node->create_service<my_interface::srv::CleanUp>(
        "cleanup_mosqibot", std::bind(handle_cleanup, this, std::placeholders::_1, std::placeholders::_2));
...
void Task::handle_cleanup(const std::shared_ptr<my_interface::srv::CleanUp::Request> request,
...
{
    cv::Mat tmp_img;
    static uint8_t n_vib = 3;   // The maximum number of vibrations.
