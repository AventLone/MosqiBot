...
private:
    ...
    rclcpp::Client<my_interface::srv::MegaMsg>::SharedPtr client_mega;
    rclcpp::Subscription<sensor_msgs::msg::Image>::SharedPtr subscription_;
    rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr target_img_publisher;
    rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr heap_img_publisher;
